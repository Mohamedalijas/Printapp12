...
TEMPLATE_PATHS = {
    'type1': os.path.join(settings.BASE_DIR, 'app1', 'Bahrain Steel Card.PNG'),
    'type2': os.path.join(settings.BASE_DIR, 'app1', 'Contractors Card BS.PNG'),
    'type3': os.path.join(settings.BASE_DIR, 'app1', 'Foulath Infotech Card.PNG'),
    'type4': os.path.join(settings.BASE_DIR, 'app1', 'SULB Card.PNG'),
}
